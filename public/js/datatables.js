...
(function (l) {
    ...
    function Ga(a, b, c) {
        ...
        b._bAttrSrc =
            l.isPlainObject(g) && (c(g.sort) || c(g.type) || c(g.filter));
        b._setter = null;
                ...
                for (h = n.length; m < h; m++)
                    if ("number" === typeof n[m] && 0 <= n[m]) {
                        ...
                        for (g = f.length; p < g; p++)
                            ("_all" == n[m] || l(f[p].nTh).hasClass(n[m])) &&
                                d(p, k);
                    }
            }
                    ...
                    (g = n[f]),
                        ...
                        g && g._bAttrSrc
                            ? (ha(g.mData._)(d, k),
                              ...
                              p(g.mData.filter, x))
                            : m
                            ? (g._setter || (g._setter = ha(g.mData)),
                              g._setter(d, k))
                            : (d[f] = k);
                f++;
            };
    ...
    function Hb(a) {
        ...
        for (
            var h = a.sDom.split(""), g, f, k, n, m, p, t = 0;
            t < h.length;
            t++
        ) {
            g = null;
            ...
            if (!f._aFilterData) {
                ...
                for (d = b.length; n < d; n++) {
                    ...
                    m.indexOf &&
                        -1 !== m.indexOf("&") &&
                        ((Qa.innerHTML = m),
                        (m = qc ? Qa.textContent : Qa.innerText));
    ...
    function Ya(a) {
        ...
        if (d || (!t && !h && !e && f == oa(a) && f == n.length))
            for (v = 0; v < f; v++)
                (k = ua(a, v)),
                    null !== k && (c[k].sWidth = K(n.eq(v).width()));
        else {
    ...
    function Ra(a) {
        ...
        if (e.bSort && e.bSortClasses) {
            ...
            for (h = b.length; e < h; e++) {
                var g = b[e].src;
                l(U(a.aoData, "anCells", g)).removeClass(
                    c + (2 > e ? e + 1 : 3)
                );
            }
            e = 0;
            for (h = d.length; e < h; e++)
                (g = d[e].src),
                    l(U(a.aoData, "anCells", g)).addClass(
                        c + (2 > e ? e + 1 : 3)
                    );
        }
        a.aLastSort = d;
    ...
    var u = function (a, b) {
            ...
            this.fnAddData = function (g, f) {
                ...
                g =
                    Array.isArray(g) &&
                    (Array.isArray(g[0]) || l.isPlainObject(g[0]))
                        ? k.rows.add(g)
                        : k.row.add(g);
                (f === q || f) && k.draw();
            ...
            this.fnGetPosition = function (g) {
                ...
                return "TR" == k
                    ...
                    : "TD" == k || "TH" == k
                    ? ((g = f.cell(g).index()),
                      [g.row, g.columnVisible, g.column])
                    : null;
            };
                ...
                if ("table" != this.nodeName.toLowerCase())
                    ...
                    for (n = v.length; k < n; k++) {
                        ...
                        if (
                            ...
                            var w =
                                f.bRetrieve !== q ? f.bRetrieve : p.bRetrieve;
            ...
            return tb(
                ...
                function (e) {
                    ...
                    if (e.nodeName) {
                        ...
                        if (f)
                            return g[f.row] && g[f.row].nTr === e.parentNode
                                ? [f.row]
                                : [];
                    ...
                    if (Array.isArray(g) || g instanceof l)
                        ...
                        g.nodeName && "tr" === g.nodeName.toLowerCase()
                            ...
                            : ((k = l("<tr><td></td></tr>").addClass(f)),
                              (l("td", k).addClass(f).html(g)[0].colSpan =
                                  oa(a)),
                              e.push(k[0]));
                };
            h(c, d);
    ...
    y("destroy()", function (a) {
        ...
        return this.iterator("table", function (b) {
            ...
            f &&
                e != f.parentNode &&
                (k.children("tfoot").detach(), k.append(f));
            b.aaSorting = [];
            b.aaSortingFixed = [];
            Ra(b);
